...
export const es: Dict = {
  ...
  platform: {
    ...
    website: {
      ...
      leadNotificationTitle: "Nueva consulta desde tu sitio web",
      leadNotificationBody: "{name} envió un mensaje desde tu sitio web. Abre el trabajo para verlo.",
  ...
  publicSite: {
    ...
    leadPhone: "Teléfono",
    leadEmail: "Correo",
    leadContactHint: "Un teléfono o un correo, el que te resulte más fácil.",
    leadService: "¿Qué necesitas?",
    leadServiceAny: "Otra cosa",
    leadZip: "Código postal",
    leadDescription: "Cuéntanos sobre el trabajo",
    leadPreferredDate: "Fecha preferida",
    leadLanguage: "Respóndeme en",
    leadConsent: "Pueden contactarme sobre esta solicitud.",
    leadSubmit: "Enviar",
    leadSending: "Enviando…",
    leadThanks: "Gracias, tu mensaje va en camino. Te contactaremos.",
    leadError: "No se envió. Inténtalo de nuevo o llámanos.",
    leadSlowDown: "Son varios mensajes seguidos. Espera un momento e inténtalo otra vez.",
    leadTitleFallback: "Consulta desde el sitio web",
    leadErrors: {
      required: "Completa este campo.",
      too_long: "Es un poco largo.",
      invalid_email: "Eso no parece un correo electrónico.",
      invalid_phone: "Eso no parece un número de teléfono.",
    },
    closed: "Cerrado",
  },
};
