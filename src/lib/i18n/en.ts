...
export const en = {
  ...
  platform: {
    ...
    website: {
      ...
      leadNotificationTitle: "New enquiry from your website",
      leadNotificationBody: "{name} sent a message through your website. Open the job to see it.",
      versionsTitle: "Published versions",
      versionLabel: "Version {version}",
      versionLive: "Live now",
      restore: "Make this live",
  ...
  publicSite: {
    ...
    leadPhone: "Phone",
    leadEmail: "Email",
    leadContactHint: "A phone number or an email — whichever is easier to reach you on.",
    leadService: "What do you need?",
    leadServiceAny: "Something else",
    leadZip: "ZIP code",
    leadDescription: "Tell us about the job",
    leadPreferredDate: "Preferred date",
    leadLanguage: "Reply in",
    leadConsent: "You can contact me about this request.",
    leadSubmit: "Send",
    leadSending: "Sending…",
    leadThanks: "Thanks — your message is on its way. We'll be in touch.",
    leadError: "That didn't send. Please try again, or call us.",
    leadSlowDown: "That's a few messages in a row. Please wait a moment and try again.",
    leadTitleFallback: "Website enquiry",
    leadErrors: {
      required: "Please fill this in.",
      too_long: "That's a bit long.",
      invalid_email: "That doesn't look like an email address.",
